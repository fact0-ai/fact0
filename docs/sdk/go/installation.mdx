---
title: Go SDK
description: Install fact0-go v1.0.3 for native Go services and sidecars.
---
...
| | |
|---|---|
| **Module** | [`github.com/fact0-ai/fact0/sdk/go`](https://github.com/fact0-ai/fact0/tree/main/sdk/go) v1.0.3 |
