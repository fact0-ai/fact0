---
title: Audit client
description: TypeScript AuditClient API reference for self-hosted audit records.
---
...
const client = new Fact0Client({
  ...
  baseUrl: process.env.FACT0_BASE_URL ?? "http://localhost:8000",
});
...
| `baseUrl` | `https://api.fact0.io` | Compatibility default; explicitly set your self-hosted origin as above |
