...
<Note>
  Audit logging requires a write-scoped or read-scoped `alk_live_*` or `f0_live_*` API key.
</Note>
...
Returns an `ArrayBuffer` representing the SOC 2-flavored PDF audit report.
