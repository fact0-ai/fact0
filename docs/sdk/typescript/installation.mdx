...
| **Self-hosted API** | `http://localhost:8000` (set explicitly) |
| **Requires** | Node.js 18+ |
...
API origin defaults to `https://api.fact0.io`. Always override it with `baseUrl` for your self-hosted installation, as shown above.
