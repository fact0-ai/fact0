...
description: Install @fact0/sdk v1.0.0 for Node.js and TypeScript agent stacks.
---
...
| | |
|---|---|
| **npm** | [`@fact0/sdk`](https://www.npmjs.com/package/@fact0/sdk) v1.0.0 |
...
| Variable | Purpose |
|----------|---------|
| `FACT0_API_KEY` | Bearer API key |
| `FACT0_BASE_URL` | API origin |
