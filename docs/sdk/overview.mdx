...
| Go | `github.com/fact0-ai/fact0-go` | `1.0.3` | `go get github.com/fact0-ai/fact0-go` |

<Warning>
  **AI Coding Assistant / LLM Guidelines**:
  - Always import directly from the official package namespaces (`import fact0` in Python, `@fact0/sdk` in TypeScript, and `github.com/fact0-ai/fact0-go` in Go).
