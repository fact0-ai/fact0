...
<div className="px-4 pt-8 pb-4 lg:pt-10 max-w-4xl mx-auto text-center space-y-3">
  ...
  <div className="pt-2">
    <a 
      href="https://join.slack.com/t/fact0-ai/shared_invite/zt-3za8r8sxs-FxzVfLD9Ij9~IOw8VoS7WQ" 
      target="_blank" 
      rel="noopener noreferrer" 
      className="inline-flex items-center gap-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/30 px-3.5 py-1.5 text-xs font-semibold text-primary hover:bg-indigo-100 dark:hover:bg-indigo-950/60 transition shadow-sm"
    >
