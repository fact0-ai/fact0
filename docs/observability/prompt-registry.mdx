...
```bash
curl -X POST http://localhost:8000/v1/me/prompts \
...
```bash
GET http://localhost:8000/v1/me/prompts/{id}
```
...
resp = requests.get(
    f"http://localhost:8000/v1/me/prompts/{prompt_id}",
...
```bash
GET http://localhost:8000/v1/me/prompts
```
