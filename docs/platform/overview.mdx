...
Fact0 Platform is the managed service behind [app.fact0.io](https://app.fact0.io). It runs the audit ingest pipeline, hash-chain verification, telemetry storage, and the compliance dashboard so you only deal with API keys and SDK calls.

## What you get

<CardGroup cols={2}>
  <Card title="Tamper-evident audit chain" icon="shield-check">
  ...
  <Card title="SOC 2 evidence packs" icon="file-pdf">
